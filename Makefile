...
$(BIN)itd: $(OBJ)main.o $(OBJ)click.o $(OBJ)color.o $(OBJ)draw.o $(OBJ)filetower.o $(OBJ)installation.o $(OBJ)joueur.o $(OBJ)map.o $(OBJ)monstre.o $(OBJ)shot.o $(OBJ)struct.o $(OBJ)texture.o $(OBJ)tower.o
...
$(OBJ)filetower.o: $(SRC)filetower.cpp $(INCL)filetower.h
	$(CC) $(CFLAGS) -o $@ -c $< $(LDFLAGS)
